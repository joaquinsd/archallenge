RSpec.describe Archallenge do
  it 'has a version number' do
    expect(Archallenge::VERSION).not_to be nil
  end
  ...
  describe 'select' do
    let(:file) { scenario1 }
    let(:selector) { Archallenge::ADSelector.new(file) }
    let(:result) { selector.select }

    context 'under scenario 1 JSON file' do
      it 'returns expected result' do
        expect(result).to eq [345048]
      end
    end

    context 'under scenario 2 JSON file' do
      let(:file) { scenario2 }
      it 'returns expected result' do
        expect(result).to eq [790952, 103678, 788138, 802358]
      end
    end

    context 'under scenario 3 JSON file' do
      let(:file) { scenario3 }
      it 'returns expected result' do
        expect(result).to eq [103678, 790952, 802358, 788138]
      end
    end

    context 'under scenario 4 JSON file' do
      let(:file) { scenario4 }
      it 'returns expected result' do
        expect(result).to eq [790952, 103678, 802358, 562873]
      end
    end
  end
end
